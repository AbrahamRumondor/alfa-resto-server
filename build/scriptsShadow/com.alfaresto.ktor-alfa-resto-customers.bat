...
set CLASSPATH=%APP_HOME%\lib\com.alfaresto.ktor-alfa-resto-customers-all.jar

@rem Execute com.alfaresto.ktor-alfa-resto-customers
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %COM_ALFARESTO_KTOR_ALFA_RESTO_CUSTOMERS_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%COM_ALFARESTO_KTOR_ALFA_RESTO_CUSTOMERS_EXIT_CONSOLE%" exit 1
exit /b 1
